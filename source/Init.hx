...
class Init extends FlxState
{
	...
	public static var gameSettings:Map<String, Dynamic> = [
		...
		'Force selected opponent' => [
			false,
			0,
			"Whether to force selected opponent or use song's opponent when available"
		],
		'Display Miss Count' => [
			false,
			0,
	...
	public static function charCheck(){
		var chars:Array<String> = ['bf','dad','gf'];
		for (id in 0 ... 2) {
			if (trueSettings.get("char" + id) == null){
				trueSettings.set("char" + id,chars[id]);
			}
		}
		// if (FlxG.save.data.char0 == null){
		// 	FlxG.save.data.char0 = "bf";
		// }
		// if (FlxG.save.data.char1 == null){
		// 	FlxG.save.data.char1 = "dad";
		// }
		// if (FlxG.save.data.char2 == null){
		// 	FlxG.save.data.char2 = "gf";
		// }
	}
	public static function getChar(id:Int = 0):String{
		return trueSettings.get("char" + id);
		// return switch(id){
		// 	case 0:
		// 		FlxG.save.data.char0;
		// 	case 1:
		// 		FlxG.save.data.char1;
		// 	case 2:
		// 		FlxG.save.data.char2;
		// 	default:"";
		// }
	}
	public static function setChar(id:Int = 0,char:String){
		// switch(id){
		// 	case 0:
		// 		FlxG.save.data.char0 = char;
		// 	case 1:
		// 		FlxG.save.data.char1 = char;
		// 	case 2:
		// 		FlxG.save.data.char2 = char;
		// }
		trueSettings.set("char" + id,char);
		saveSettings();
	}
	...
	public static function saveSettings():Void
	{
		...
		// if(trueSettings.characters == null){
		// 	trueSettings.characters = ["bf","dad","gf"];
		// }
		FlxG.save.flush();
