...
class PlayState extends MusicBeatState
{
	...
	public static var earlys:Int = 0;
	public static var lates:Int = 0;
	...
	var moddedSong:Bool = false;
	var loadedInst:FlxSound;
	var loadedVoices:FlxSound;

	public static var returnUI:Int = 0;
	static var keepScore:Bool = false;
	...
	function finishSong(?win:Bool = false){
		persistentUpdate = false;
